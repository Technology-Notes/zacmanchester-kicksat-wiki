...
After decompressing, you should see a folder called "KickSatVM" with two files inside ("KickSat.vmx" and "KickSat.vmdk"). Double click "KickSat.vmx" and VMWare Player should start up and boot the virtual machine.